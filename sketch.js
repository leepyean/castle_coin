...
function preload()
{
	...
	charU = loadAnimation("maru1.png","maru2.png","maru3.png")
	...
	flower1Img =loadImage("virag_1.png");
	flower2Img =loadImage("virag_2.png");
	flower3Img =loadImage("virag_3.png");
	cloudImg =loadImage("cloud.png");
	enemyImg=loadImage("enemy.png");
	coinI=loadImage("money.png");
	mainenI=loadImage("mainboss.png");
	bakI=loadImage("back.png");
	...
	go=loadSound("loose.mp3");
	wow=loadSound("win.mp3");
}
